...
// console.log(numberOfOccurrences(["key", "value"], "not an array", ["key", "value"]))
...
// console.log(replaceCharsAtIndexes("foobar", [0])); // Throws Error
// console.log(replaceCharsAtIndexes("", [1])); // Throws Error
// console.log(replaceCharsAtIndexes(12345, [2])); // Throws Error
// console.log(replaceCharsAtIndexes("string", [0, 6])); // Throws Error
